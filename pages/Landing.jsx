    ...
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '3rem 2rem 5rem', fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center', marginBottom: '5rem' }}>
        ...
        <div style={{
          ...
          borderRadius: '24px',
          padding: '1.8rem',
          boxShadow: '0 0 15px rgba(114,132,151,0.5), 0 0 30px rgba(114,132,151,0.3)',
      ...
      <style>{`
        ...
        @keyframes pulseGlow {
          0% { box-shadow: 0 0 5px rgba(114,132,151,0.3); }
          50% { box-shadow: 0 0 25px rgba(114,132,151,0.8), 0 0 10px rgba(114,132,151,0.5); }
          100% { box-shadow: 0 0 5px rgba(114,132,151,0.3); }
        }
        @keyframes fadeIn {
